 ...
 *   • AT RUNTIME, on the first lock connection: the override must be SHOWN to share an
...
export function pgSessionLockConnectionConfig(databaseUrl, sessionLockUrl, purpose = 'a session advisory lock', options = {}) {
  ...
  // established: an operator who set it wrongly is told at the first lock, not at import time.
