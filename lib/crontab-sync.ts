 ...
 * that the schedule exists, and those are different facts on a hardened unit where the binary's
 * setgid transition is suppressed (see deploy/systemd/ims-stage.service). The confirmation has to
