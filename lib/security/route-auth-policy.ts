...
export const apiRouteAuthPolicy = {
  ...
  '/api/export/purchasing-analytics': {
    access: 'authenticated',
    reason: 'Requires purchasing analytics access: ADMIN, MANAGER, or FINANCE role.',
  },
