...
export default async function CurrencySummaryAnalyticsPage({ searchParams }: Props) {
  ...
  const report = await loadFinanceAnalyticsReportForPage(filters, getCurrencySummaryReport, { salesBase: '0', arOutstandingBase: '0', purchasesBase: '0', apOutstandingBase: '0' })
  return (
