...
export const salesAnalyticsEmptyTotals = {
  // o3d-kyey: the bound fields default to 'exact' and NOT to a blank. A refused source scan
  // publishes zeroes, and a zero with no bound beside it is the honest reading of "nothing was
  ...
  customers: { revenueBase: '0', netRevenueBase: '0', netRevenueBaseBound: 'exact', netRevenueExVatBase: '0', grossProfitBase: '0', grossProfitBaseBound: 'exact', costCapturedRows: '0', costInconsistentRows: '0', arExposureBase: '0', arExposureBaseBound: 'exact', refundsNetBasis: '0', refundsGrossBasis: '0', refundsUnknownBasis: '0' },
