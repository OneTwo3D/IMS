...
export const salesAnalyticsEmptyTotals = {
  ...
  customers: { revenueBase: '0', netRevenueBase: '0', netRevenueBaseBound: 'exact', netRevenueExVatBase: '0', grossProfitBase: '0', grossProfitBaseBound: 'exact', costCapturedRows: '0', arExposureBase: '0', refundsNetBasis: '0', refundsGrossBasis: '0', refundsUnknownBasis: '0' },
