    ...
    const mounted = mountClientComponent(ProductProfitabilityClient as unknown as (props: unknown) => unknown, {
      data: {
        rows: [{
          ...
          currentFyRefundBasisComplete: false, currentFyRevenueBound: 'upper', currentFyCogs: 40, currentFyProfit: 60, currentFyQtySold: 1,
          previousFyRevenue: 50, previousFyRefundsGrossBasis: 0, previousFyRefundsUnknownBasis: 0,
          previousFyRefundBasisComplete: true, previousFyRevenueBound: 'exact', previousFyCogs: 20, previousFyProfit: 30, previousFyQtySold: 1,
        }],
        summary: {
          totalProducts: 1,
          currentFyRevenue: 100, currentFyRefundsGrossBasis: 120, currentFyRefundsUnknownBasis: 0,
          currentFyRefundBasisComplete: false, currentFyRevenueBound: 'upper', currentFyCogs: 40, currentFyProfit: 60,
          previousFyRevenue: 50, previousFyRefundsGrossBasis: 0, previousFyRefundsUnknownBasis: 0,
          previousFyRefundBasisComplete: true, previousFyRevenueBound: 'exact', previousFyCogs: 20, previousFyProfit: 30,
