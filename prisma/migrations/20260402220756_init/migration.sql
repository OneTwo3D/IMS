...
CREATE TABLE "purchase_order_lines" (
    ...
    "totalForeign" DECIMAL(18,4) NOT NULL,
    "totalBase" DECIMAL(18,4) NOT NULL,
    "landedUnitCostBase" DECIMAL(18,6) NOT NULL DEFAULT 0,
...
CREATE TABLE "sales_orders" (
    ...
    "currency" TEXT NOT NULL DEFAULT 'GBP',
    "fxRateToBase" DECIMAL(18,8) NOT NULL DEFAULT 1,
    "customerName" TEXT,
    "customerEmail" TEXT,
    ...
    "totalForeign" DECIMAL(18,4) NOT NULL,
    "subtotalBase" DECIMAL(18,4) NOT NULL,
    "shippingBase" DECIMAL(18,4) NOT NULL DEFAULT 0,
    "taxBase" DECIMAL(18,4) NOT NULL DEFAULT 0,
    "totalBase" DECIMAL(18,4) NOT NULL,
...
CREATE TABLE "sales_order_lines" (
    ...
    "unitPriceBase" DECIMAL(18,6) NOT NULL,
    "taxRateId" TEXT,
    "taxForeign" DECIMAL(18,4) NOT NULL DEFAULT 0,
    "taxBase" DECIMAL(18,4) NOT NULL DEFAULT 0,
    "totalForeign" DECIMAL(18,4) NOT NULL,
    "totalBase" DECIMAL(18,4) NOT NULL,
    "cogsBase" DECIMAL(18,4),
